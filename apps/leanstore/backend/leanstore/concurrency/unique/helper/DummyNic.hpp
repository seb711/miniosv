...
class DummyNIC
{
  ...
  public:
   // std::random_device is disabled in OSv's slim libc++; seed gen_ deterministically.
   DummyNIC(double rate) : buffer_(), next_time_(0), rate_(rate), gen_(0xC0FFEE), dist_(rate), config_(nullptr)
   {
