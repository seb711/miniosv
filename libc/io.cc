...
OSV_LIBC_API ssize_t __pread64_chk(int, void *, size_t, off_t, size_t) { errno = EBADF; return -1; }
OSV_LIBC_API ssize_t __read_chk(int, void *, size_t, size_t) { errno = EBADF; return -1; }
