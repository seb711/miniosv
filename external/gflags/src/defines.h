...
// OSv ships <fnmatch.h> but llvm-libc provides no fnmatch() implementation, so
// leave this undefined: gflags' --fromenv glob path (unused here) then compiles
// out instead of leaving an undefined reference to fnmatch.
